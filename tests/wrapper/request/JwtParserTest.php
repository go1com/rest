...
{
    // constant for other test cases to reuse.
    CONST SYSTEM_USER = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..kEKp1dQ5tJRVeUQQ_j47s2BhRJnreMRP_XpsAlNaXcI';
    ...
    public function testSystemUser()
    {
        $this->assertTrue(
            $this
                ->mf()
                ->createRequest('GET', '/auth?jwt=' . static::SYSTEM_USER)
                ->isSystemUser()
        );
    }
}
